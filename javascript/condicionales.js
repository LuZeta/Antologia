...
function crearplantilla() {
  alert(
    UserName +
      ", " +
      "elige las siguientes opciones para crear tu plantilla personalizada"
  );
  let color = prompt("color de fondo");
  let animales = prompt("elige que mascota te acompañara");
  let fecha = prompt(
    "escribe la fecha de hoy para guardar tu plantilla diaria"
  );
  return prompt(
    "Se creara la siguiente plantilla: " +
      "fondo: " +
      color +
      " / " +
      "mascota: " +
